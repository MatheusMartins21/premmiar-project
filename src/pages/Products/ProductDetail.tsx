...
export const ProductDetail: React.FunctionComponent<IProps> = ({ getDetailProduct, products }) => {
	const { uuid } = useParams();
	React.useEffect(() => {
		getDetailProduct(uuid);
	}, [getDetailProduct]);
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    getDetailProduct: (uuid: string) => dispatch(getDetailProduct(uuid)),
  }
}
